...
const Login = ({ email, password, onEmailChange, onPasswordChange, onSubmit, error, showPassword, setShowPassword, switchToSignup }) => (
  <div className="min-h-screen flex items-center justify-center bg-primary px-2">
    <div className="bg-grayDark p-8 rounded shadow-lg w-full max-w-xs sm:max-w-md mx-auto">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-primary text-secondary py-2 rounded hover:bg-gray transition">Login</button>
      </form>
